        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <button
              ...
              className="mt-1.5 inline-block bg-black px-5 py-3 rounded-3xl text-xs font-medium uppercase tracking-wide text-white"
            >
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:items-stretch">
            <div className="grid p-6 bg-gray-100 rounded-xl place-content-center sm:p-8">
              <div className="max-w-md mx-auto text-center lg:text-left">
                ...
                <button
                  onClick={() => router.push("/product/listing/all-products")}
                  className="rounded-3xl mt-1.5 inline-block bg-black px-5 py-3 text-xs font-medium uppercase tracking-wide text-white"
                >
                  Shop ALL
                </button>
              </div>
